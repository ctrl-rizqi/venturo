...
function RouteComponent() {
	return (
		<main className="page-wrap px-4 pb-10 pt-10 sm:pt-14">
			<section className="island-shell rise-in grid overflow-hidden rounded-[2rem] border border-[var(--line)] lg:grid-cols-[1.08fr_1fr]">
				<aside className="relative border-b border-[var(--line)] bg-[linear-gradient(155deg,color-mix(in_oklab,var(--surface-strong)_90%,white_10%),color-mix(in_oklab,var(--lagoon)_18%,var(--surface)))] px-7 py-9 sm:px-10 sm:py-12 lg:border-b-0 lg:border-r">
					...
					<p className="mt-4 max-w-md text-sm leading-relaxed text-[var(--sea-ink-soft)] sm:text-base">
